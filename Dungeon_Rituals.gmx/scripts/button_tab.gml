///button_tab_frozen(spr,x,y,w,h,text,bpic,subimg,name,var,tabval)//
...
if thistab=0
    ...
    if in 
        {
        draw_sprite_stretched_ext(argument0,4+mouse_check_button(1),argument1,argument2,argument3,argument4,c_white,1)    
        }
    else
